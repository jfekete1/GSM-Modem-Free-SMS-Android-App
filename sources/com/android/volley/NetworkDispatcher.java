...
public class NetworkDispatcher extends Thread {
    ...
    public void run() {
        ...
        while (true) {
            try {
                ...
                VolleyLog.m11e("Ignoring spurious interrupt of NetworkDispatcher thread; use quit() to terminate it", new Object[0]);
            }
        }
    }
    ...
    public void processRequest(Request<?> request) {
        ...
        try {
            ...
            VolleyLog.m12e(e2, "Unhandled exception %s", e2.toString());
